...
export default definePluginEntry({
    ...
    register(api) {
        ...
        api.registerTool({
            ...
            description: "Replace a bucket's memory.md with updated content. This is an ALWAYS-EDIT operation — " +
        ...
        api.registerTool({
            ...
            description: "Replace _personal.md at the vault root with updated content. This is an ALWAYS-EDIT " +
            ...
            async execute(_toolCallId, params) {
                ...
                return {
                    content: [{ type: "text", text: "Personal memory updated." }],
                    details: {},
                };
            },
        });
        ...
        api.registerTool({
            ...
            description: "Read _personal.md from the vault root. Contains cross-project personal patterns. " +
            ...
            async execute() {
                ...
                if (!existsSync(personalFile)) {
                    return {
                        content: [{ type: "text", text: "No _personal.md yet." }],
                        details: { found: false },
                    };
                }
        ...
        api.registerTool({
            ...
            async execute(_toolCallId, params) {
                ...
                if (fm.aliases.includes(normalized)) {
                    return {
                        content: [{ type: "text", text: `Alias already exists on ${slug}.` }],
                        details: { added: false },
                    };
                }
